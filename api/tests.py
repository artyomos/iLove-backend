...
def test():
    with main.app.app_context():
        ...
        increment(check_value("Creation of User 'Anubis'", "Created Reference for user: Anubis", user['debug']))
        ...
        increment(check_value("Adding of Huskies :)", {'huskies': 9999999}, given['interests']))
        ...
        increment(check_value("Adding of Pokemon", {'huskies': 9999999, 'pokemon': 100}, given['interests']))
        ...
        increment(check_value("Adding of Dummy Interest", {'huskies': 9999999, 'pokemon': 100, 'useless': 1}, given['interests']))

        # Remove Previously added Interest
        given = interests.remove_interest(package).get_json()

        increment(check_value("Removal of Dummy Interest", {'huskies': 9999999, 'pokemon': 100}, given['interests']))
